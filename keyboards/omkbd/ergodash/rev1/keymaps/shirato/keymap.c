...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_ESC,                         KC_DEL,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    BL_TOGG,                        KC_APP , KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, LOWER,   KC_LGUI, KC_LALT,          LOWER,   KC_SPC , KC_ENT,        KC_ENT, KC_SPC , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                        _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_COLN, KC_DQT,
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    RESET,                          RESET,   _______, _______, KC_LT,   KC_GT,   KC_QUES, _______,
  ...
  [_ADJUST] = LAYOUT(
    ...
    // _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______
    _______, _______, _______, _______, _______, _______,_______,                       _______, _______, _______, _______, _______, _______, _______,
    RGB_TOG, QK_BOOT, RGB_MOD, RGB_RMOD,RGB_HUD, RGB_HUI,_______,                       _______, _______, KC_VOLU, _______, _______, _______, _______,
    _______, _______, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI,_______,                       _______, _______, KC_VOLD, _______, _______, _______, _______,
    _______, _______, BL_TOGG, BL_BRTG, BL_INC , BL_DEC ,_______,                       _______, _______, KC_MUTE, _______, _______, _______, _______,
    _______, _______, _______, _______,          _______,_______,_______,       _______,_______, _______,          _______, _______, _______, _______
  )
};
