...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    ...
    _______,     KC_LEFT, KC_DOWN, KC_RIGHT, KC_END, RGB_RMOD,   XXXXXXX, KC_VOLD, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT,        XXXXXXX,
    _______,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGBRST,   XXXXXXX, KC_MUTE, KC_END, KC_PGDN, KC_DOWN, _______, KC_PGUP, _______,
    _______,   _______,    _______,    _______,    OVR_ON,       OVR_OFF, XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_END
  )
};
